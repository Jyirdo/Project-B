...
public class StaffMenu : View
{
    public static string Show()
    {
        ...
        WriteLine("Toets \x1b[33m'T'\x1b[0m en druk ENTER om een gids toe te voegen aan een rondleiding.");
        WriteLine("Toets \x1b[33m'V'\x1b[0m en druk ENTER om een gids te verwijderen uit een rondleiding.");
