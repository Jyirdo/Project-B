...
public static class Advise
{
    ...
    private static string GetPresenceData()
    {
        if (File.Exists("../../../StorageFiles/started_tours.json"))
        {
            ...
            string json = File.ReadAllText("../../../StorageFiles/started_tours.json");
    ...
    private static void KeepStartedToursUpToDate()
    {
        ...
        List<StartedTour> startedList = JsonConvert.DeserializeObject<List<StartedTour>>(File.ReadAllText("../../../StorageFiles/started_tours.json"));
        ...
        File.WriteAllText("../../../StorageFiles/started_tours.json", updatedStartedTours);
    }
